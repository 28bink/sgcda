...
<div class="container">		
	<h1>CHAT CENTRO DE INSPECCION TOTAL BOYACA</h1>		
	<br>		
		...
		<div class="chat">	
			<div id="frame">		
				<div id="sidepanel">
					...
					echo '
					<h4>NOTAS RAPIDAS</h4>
					<div> * Envío resultados PLACA: <br></div>
					<div> * Ingeniero Samuel A. se requiere para Huella <br></div>
					<div> * Ingeniero Diego D. se requiere para Huella <br></div>
					<div> * DT se presenta vehiculo de PLACA: con la siguiente inconsistencia ().</div>
					<div> * El vehículo PLACA: se retira por la siguiente novedad ().</div>
					<div> * DT el conductor PLACA: esta preguntando por su vehiculo.</div>
					<div> ==================================</div>
					<div> * (APROBADO)= </div>
					<div> * (RECHAZADO)= </div>
					</ul>';
				...
				<div class="content" id="content"> 
					...
					<div class="message-input" id="replySection">				
						<div class="message-input" id="replyContainer">
							<div class="wrap">
								<input type="text" class="chatMessage" id="chatMessage
								<?php echo $currentSession;
	...
	<br>
	<br>	
	<div style="margin:50px 0px 0px 0px;" align="center">
		<a class="btn btn-default read-more" style="background:#3399ff;color:white" href="http://192.168.3.114/onac">Volver al APP</a>		
	</div>	
</div>	
