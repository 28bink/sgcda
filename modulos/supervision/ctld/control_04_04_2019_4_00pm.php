...
<table border="1">
	...
	<?php 
		...
		if (($preinspeccion==$na)&&($visual==$na)&&($frenosp==$na)&&($lucesp==$na)&&($suspensionp==$na)&&($gases4983==$na)&&($gases4231==$na)&&($v122_sv==$na)&&($v123_sv==$na)&&($ruidos4194==$na))
			{
				echo "<br> ING.".$v3_sv_datos." EL FORMULARIO DE SUPERVISION NO ESTA DILIGENCIADO";
			}
		else
			{
			...
			if ($promedio_supervision<=2.5) {
				$v127_sv="No mantiene la Competencia de Inspección";
			}
			if ($promedio_supervision==5) {
				$v127_sv="Mantiene la Competencia de Inspección";
			}
	?>
